...
public class ModelAdapterHeadWitherSkeleton extends ModelAdapter
{
    public ModelAdapterHeadWitherSkeleton()
    {
        super(TileEntityType.SKULL, "head_wither_skeleton", 0.0F);
    }
    ...
    public IEntityRenderer makeEntityRender(Model modelBase, float shadowSize)
    {
        ...
        else
        {
            ...
            {
                map.put(SkullBlock.Types.WITHER_SKELETON, modelBase);
