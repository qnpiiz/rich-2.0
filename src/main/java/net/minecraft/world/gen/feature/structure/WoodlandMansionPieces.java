    ...
    static class Grid
    {
        ...
        private void setupThirdFloor()
        {
            ...
            else
            {
                ...
                Direction direction1 = this.get1x2RoomDirection(this.baseGrid, tuple.getFirst(), tuple.getSecond(), 1, l1 & 65535);
                int i2 = tuple.getFirst() + direction1.getXOffset();
                int i1 = tuple.getSecond() + direction1.getZOffset();
