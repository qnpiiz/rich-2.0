...
public class EndPortalTileEntityRenderer<T extends EndPortalTileEntity> extends TileEntityRenderer<T>
{
    ...
    private static final List<RenderType> RENDER_TYPES = IntStream.range(0, 16).mapToObj((p_lambda$static$0_0_) ->
    {
        return RenderType.getEndPortal(p_lambda$static$0_0_ + 1);
